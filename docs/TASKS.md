...
| 6d | Eden Gmail wiring (her personal cgm) | 🔲 Not started | 🔴 | Add `GOOGLE_TOKEN_EDEN_CGM`; per-user account resolution so Eden's "cgm" → her account; Eden gets `gmail` permission. OAuth `edeng.cgm@gmail.com`. |
